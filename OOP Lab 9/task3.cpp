...
int main()
{
    ...
    courses[0] = new LectureCourse("CS101-Abdullah Karim", 3, 30, 50, 20);
    courses[1] = new LectureCourse("MATH202-Hassan", 4, 25, 60, 15);
    courses[2] = new LabCourse("PHYS103-Ahsan", 2, 50, 40, 10);
    courses[3] = new LabCourse("BIO205-Asif", 3, 45, 45, 10);

    ((LectureCourse *)courses[0])->setScores(84.0, 91.0, 77.0);
    ((LectureCourse *)courses[1])->setScores(72.0, 85.0, 88.0);
    ((LabCourse *)courses[2])->setScores(87.0, 90.0, 98.0);
    ((LabCourse *)courses[3])->setScores(78.0, 83.0, 92.0);
