...
int main()
{
    Patient p1("Ali Ahmed", 30, "03001234567", 101, "Diabetes", "Dr. Ahmed");
    Doctor d1("Abdullah Karim", 45, "03211234567", "Cardiologist", 5000, "Ali Khan, Bilal");
    Nurse n1("shamveel", 28, "03151234567", "Emergency", "Night");
    Administrator a1("usman", 50, "03451234567", "HR", 100000);
